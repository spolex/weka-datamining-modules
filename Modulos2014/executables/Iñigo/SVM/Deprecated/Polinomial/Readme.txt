...
positiva. Los parámetros que se optimizan son cost y gamma para el kernel polinomial.

==================================================================================================================
Argumentos:
	- Fichero .arff de entrenamiento.
	- Fichero .arff dev.
	- (Opcional) cotas superiores del barrido para cost, gamma y degree
	- Ejemplo: java -jar ScanSvmPolinomial-<versión>.jar ScatteringNeutrons_Train.arff ScatteringNeutrons_dev.arff 11 4 2
==================================================================================================================
Precondiciones:
	- La clase en los ficheros .arff debe encontrarse en última posición.
	- En caso de decidir introducir los parámetros serán todos, en caso 
	contrario unicamente se acotarán los introducidos en el orden que corresponda 
	cost, gamma, degree.

Postcondiciones:
	- Se obtiene un fichero .model con los mejores resultados del modelo
	  obtenidos en el barrido ad-hoc, guardándose en la misma ruta <directorio_donde_se_encuentra_jar>/Modelos/<nombre>.model
==================================================================================================================
...
En caso de que no tenga los permisos suficientes para poder ejecutarlo se los asignamos:
		...
		$sudo chmod 755 ScanSvmPolinomial-<versión>.jar
...
3. Volvemos al directorio home de nuestro usuario e introducimos el comando para ejecutar ScanSvmRbfParams<version>.jar:
		...
		cd ..
		$java -jar -Xmx2048m ScanSvmPolinomial-<versión>.jar "path_train" "path_dev" <argumentos>
...
en el directorio bin, como se ha descrito en los puntos anteriores, introducimos el siguiente comando:
		...
		$java -jar -Xmx2048m ScanSvmPolinomial-<versión>.jar data/train.arff data/dev.arff -14 -2 2
