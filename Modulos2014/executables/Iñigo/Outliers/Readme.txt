...
El objetivo principal del sistema es detectar y eliminar tanto Outliers como Extreme value en el conjunto de entrenamiento
...
Argumentos:
	...
	- Ejemplo: java -jar Outliers-<versión>.jar ScatteringNeutrons_Train.arff
==================================================================================================================
Precondiciones:
	- La clase en los ficheros .arff debe encontrarse en última posición.

Postcondiciones:
	- Se obtiene un fichero .arff NUEVO con las instancias detectadas como outliers o extreme values eliminadas.
		- Se creará un directorio con la fecha y la hora actual sin minutos, en el se guardará el fichero con el 
		patrón <nombre_fichero_de_entrenamiento>_<fecha-hora>_WithoutOutLiers.arff
==================================================================================================================
...
En caso de que no tenga los permisos suficientes para poder ejecutarlo se los asignamos:
		...
		$sudo chmod 755 Outliers-<versión>.jar
...
3. Volvemos al directorio Filtros e introducimos el comando para ejecutar Outliers-<versión>.jar:
		...
		cd ..
		$java -jar -Xmx512m Outliers-<versión>.jar "path_train" 
...
en el directorio, como se ha descrito en los puntos anteriores, introducimos el siguiente comando:
		...
		$java -jar -Xmx512m Outliers-<versión>.jar examples/ionosphere.arff 
