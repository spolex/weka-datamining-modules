...
public class GeneracionPredicciones {
	...
	public static void main(String[] args) {
		if(args.length == 2)
		{
			...
			/********************Bloque de creación de los ficheros*****************************/
			
			PrintStream salidaPredicciones = crearFichero(rutaIntancias, "-pred-prob.txt");
			PrintStream salidaEstClase = crearFichero(rutaIntancias, "-predicciones.txt");
			...
			pred.calcularPrediccionesConProbabilidad(test, salidaPredicciones, salidaEstClase);
