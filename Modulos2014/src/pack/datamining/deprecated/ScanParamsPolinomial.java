package pack.datamining.deprecated;
...
public class ScanParamsPolinomial extends ScanSvmParams {
	...
	public LibSVM scanParams(int pCmax,int pGMax, int pDmax){
		...
		for (int d=2;d<maxOfDegreeSearch;d++)
		{
			...
			for (int c = -15; c <= mMaxOfCSearch; c++) {
				percent = (c+15)*100/(mMaxOfCSearch+30);
				...
				{
					percent = (g+3)*100/(mMaxOfGSearch+6);
